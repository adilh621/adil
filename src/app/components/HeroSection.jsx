...
export default function HeroSection() {
  return (
    ...
    />
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight font-sans animate-fade-in">
          Hi, I'm Adil Hussain
        </h1>

        <p className="text-2xl md:text-3xl font-medium leading-snug tracking-wide font-sans animate-fade-in-slow">
          Full Stack JavaScript Developer • Next.js Enthusiast • Educator
        </p>

        <div className="flex flex-wrap justify-center gap-4 text-2xl animate-fade-in-slow">
